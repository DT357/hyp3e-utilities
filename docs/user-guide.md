...
- At the normal Party Sheet width, HP, Move, Roll Save, Roll Morale, and remove
  occupy the first line; AC, DR, Share, Wage, and Save occupy the second. The
  roll-button group and remove control remain right aligned.
